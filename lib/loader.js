...
module.exports = function (content) {
  ...
  var midLoaders = options.midLoaders || {}
  ...
  function getRawLoaderString (type, part, index, scoped) {
    ...
    var styleCompiler = ''
    var midStyleLoader = midLoaders[lang] ? ensureBang(midLoaders[lang]) : '';
    if (type === 'styles') {
      // style compiler that needs to be applied for all styles
      styleCompiler = midStyleLoader + styleCompilerPath + '?' + JSON.stringify({
