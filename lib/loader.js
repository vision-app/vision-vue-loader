...
module.exports = function (content) {
  ...
  var bubleOptions = hasBuble && options.buble
    ...
    : ''
  var babelOptions = hasBabel && options.babel
    ? '?' + JSON.stringify(options.babel)
    : ''
      ...
      if (moduleName) {
        ...
        if (moduleName in cssModules) {
          ...
          styleInjectionCode += `
              ...
              if (oldLocals && oldLocals.root === '${fileName}')
          ...
          if (!needsHotReload) {
            ...
            output +=
              ...
              `  var newLocals = ${requireString}\n` +
              `  if (oldLocals && oldLocals.root === '${fileName}') newLocals = Object.assign({}, oldLocals, newLocals);\n` +
